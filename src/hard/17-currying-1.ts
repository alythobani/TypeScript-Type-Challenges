...
type CurryingType<Fn> = Fn extends (...args: infer Args) => infer Return
  ? Args extends [] | [unknown]
    ? Fn
    : Args extends [infer Arg, ...infer Rest]
    ? (arg: Arg) => CurryingType<(...args: Rest) => Return>
    : never
  : never;

declare function Currying<Fn extends Function>(fn: Fn): CurryingType<Fn>;
