...
type BEMTemplate<
  EOrM extends string[],
  BEMPrefix extends string,
  U extends string = never
> = EOrM extends [infer First extends string, ...infer Rest extends string[]]
  ? BEMTemplate<Rest, BEMPrefix, U | `${BEMPrefix}${First}`>
  : [U] extends [never]
  ? ""
  : U;
...
type BEM<
  ...
  E extends string[],
  M extends string[]
> = `${B}${BEMTemplate<E, "__">}${BEMTemplate<M, "--">}`;
